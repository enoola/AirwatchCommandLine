...
use PhPeteur\AirwatchWebservices\Services\AirwatchMDMDeviceCertificatesSearch;
 ...
 */
class MDMDeviceCertificatesSearchCommand extends AirwatchCmd
{
    protected function configure()
    {
        $this->_oAW = new AirwatchMDMDeviceCertificatesSearch($this->_config);
        if (is_null($this->_oAW))
            die ("Unable to create AirwatchMDMDeviceSecuritySearch object :/");

        $this->setName('mdm-device-certificates-search');

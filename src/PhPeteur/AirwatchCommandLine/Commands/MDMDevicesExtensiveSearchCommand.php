...
use PhPeteur\AirwatchWebservices\Services\AirwatchMDMDevicesExtensiveSearch;

/*
 * Device Extensive Search
 * Functionality – Search results containing the devices and their product assignment information.
*/
class MDMDevicesExtensiveSearchCommand extends AirwatchCmd
{


    protected function configure()
    {
        $this->_oAW = new AirwatchMDMDevicesExtensiveSearch( $this->_config );
        if (is_null( $this->_oAW))
            die ("Unable to create AirwatchMDMDevicesExtensiveSearch object :/");

        $this->setName('mdm-devices-extensive-search');

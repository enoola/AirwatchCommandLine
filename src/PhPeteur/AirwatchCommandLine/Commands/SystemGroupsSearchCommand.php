...
class SystemGroupsSearchCommand extends AirwatchCmd
{

    protected function configure()
    {
        $this->_oAW = new AirwatchSystemGroupsSearch($this->_config);
        if (is_null($this->_oAW))
            throw new AirwatchCmdException('unable to create AirwatchSystemGroupsSearch object within' . __CLASS__, 42);

        $this->setName('system-groups-search');
